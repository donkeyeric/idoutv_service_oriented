<?php
namespace IdoutvServiceOriented\Library\Upload\Qiniu;
...
class QiniuDriver
{
    ...
    private $config = array(
        'secretKey' => 'i74JWW2DrGAHxOtkZgDR82yZCahq9fHfMIH3O17I', // 七牛服务器
        'accessKey' => 'GkdU4kgD4M1OaA8H0bPz2qF8E6rkBpvWu2GzTdv_', // 七牛用户
        'domain' => 'ozr8g8dil.bkt.clouddn.com', // 七牛密码
        'bucket' => 'moguvideo', // 空间名称
        'timeout' => 300 // 超时时间
    );
